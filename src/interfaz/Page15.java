 ...
 * @author USUARIO
 */
public class Page15 extends javax.swing.JPanel {
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Verificar si el evento x tiene seguridad ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(eventox, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
...
String nombreEvento = eventox.getText().trim();


        if (nombreEvento.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, ingrese el nombre del evento.");
            return;
        }
        ...
        modeloTabla.addColumn("Tiene Seguridad");
        modeloTabla.addColumn("Nombre de Empresa");
        modeloTabla.addColumn("Cantidad Seguridad");
        modeloTabla.addColumn("Tipo de Seguridad");
                ...
                while (!pilaEventos.esVacia()) {
                    ...
                    if (evento.getNombre().equalsIgnoreCase(nombreEvento)) {
                        ...
                        if (evento.getLd_NormalSeguridad() != null && !evento.getLd_NormalSeguridad().esVacia()) {
                            NodoSeguridad nodo = evento.getLd_NormalSeguridad().getP();
                            while (nodo != null) {
                                Seguridad seguridad = nodo.getSeg();
                                modeloTabla.addRow(new Object[]{
                                    evento.getNombre(),
                                    "Sí",
                                    seguridad.getNomEmpresa(),
                                    seguridad.getCantidadSeguridad(),
                                    seguridad.getTipoSeguridad()
                                });
                                nodo = nodo.getSig();
                            }
                        } else {
        ...
        if (!encontrado) {
            JOptionPane.showMessageDialog(this, "No se encontró ningún evento con el nombre '" + nombreEvento + "'.");
        }
